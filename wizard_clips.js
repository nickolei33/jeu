...
(() => {
  ...
  function makeRunClip() {
    // STAFF STABILIZATION V3
    // - flattened root.y range (3,4 -> 2) almost static to prevent whole-body bounce
    // - locked armR angles to very small range to keep staff steady
    const frames = [
      { t: 0.0, root: { x: 4, y: 3 }, bones: { spine: -35, neck: 25, legL_up: 50, legL_lo: -10, legR_up: -30, legR_lo: 20, armL_up: -40, armL_lo: 40, armR_up: -45, armR_lo: -45, cape: -10 } },
      { t: 0.0625, root: { x: 2, y: 4 }, bones: { spine: -34, neck: 24, legL_up: 40, legL_lo: 20, legR_up: -20, legR_lo: 40, armL_up: -25, armL_lo: 30, armR_up: -46, armR_lo: -44, cape: -5 } },
      { t: 0.125, root: { x: 0, y: 3 }, bones: { spine: -32, neck: 22, legL_up: 10, legL_lo: 40, legR_up: 20, legR_lo: 60, armL_up: 10, armL_lo: 20, armR_up: -47, armR_lo: -43, cape: 0 } },
      { t: 0.1875, root: { x: 2, y: 2 }, bones: { spine: -34, neck: 24, legL_up: -10, legL_lo: 30, legR_up: 40, legR_lo: 30, armL_up: 25, armL_lo: 10, armR_up: -46, armR_lo: -44, cape: -5 } },
      { t: 0.25, root: { x: 4, y: 3 }, bones: { spine: -35, neck: 25, legL_up: -30, legL_lo: 20, legR_up: 50, legR_lo: -10, armL_up: 35, armL_lo: 20, armR_up: -45, armR_lo: -45, cape: -10 } },
      { t: 0.3125, root: { x: 2, y: 4 }, bones: { spine: -34, neck: 24, legL_up: -20, legL_lo: 40, legR_up: 40, legR_lo: 20, armL_up: 25, armL_lo: 30, armR_up: -46, armR_lo: -44, cape: -5 } },
      { t: 0.375, root: { x: 0, y: 3 }, bones: { spine: -32, neck: 22, legL_up: 20, legL_lo: 60, legR_up: 10, legR_lo: 40, armL_up: -10, armL_lo: 20, armR_up: -47, armR_lo: -43, cape: 0 } },
      { t: 0.4375, root: { x: 2, y: 2 }, bones: { spine: -34, neck: 24, legL_up: 40, legL_lo: 30, legR_up: -10, legR_lo: 30, armL_up: -35, armL_lo: 30, armR_up: -46, armR_lo: -44, cape: -5 } },
      { t: 0.5, root: { x: 4, y: 3 }, bones: { spine: -35, neck: 25, legL_up: 50, legL_lo: -10, legR_up: -30, legR_lo: 20, armL_up: -40, armL_lo: 40, armR_up: -45, armR_lo: -45, cape: -10 } }
    ];
  ...
  function makeFallClip() {
    return {
      name: 'fall', loop: true, duration: 0.4,
      keyframes: [
        { t: 0, root: { x: 0, y: -4 }, bones: { spine: 10, neck: 10, legL_up: -20, legL_lo: 10, legR_up: -5, legR_lo: 40, armL_up: -60, armL_lo: -20, armR_up: -70, armR_lo: -30, cape: -60 } },
        { t: 0.2, root: { x: 0, y: -2 }, bones: { spine: 5, neck: 15, legL_up: -10, legL_lo: 20, legR_up: -15, legR_lo: 30, armL_up: -50, armL_lo: -10, armR_up: -60, armR_lo: -20, cape: -70 } },
        { t: 0.4, root: { x: 0, y: -4 }, bones: { spine: 10, neck: 10, legL_up: -20, legL_lo: 10, legR_up: -5, legR_lo: 40, armL_up: -60, armL_lo: -20, armR_up: -70, armR_lo: -30, cape: -60 } }
      ]
    };
  }
  ...
  loadWizardClips([makeIdleClip(), makeWalkClip(), makeRunClip(), makeJumpClip(), makeFallClip(), makeCastClip()]);
})();
